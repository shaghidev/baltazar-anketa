...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#4B5563", color: "#9CA3AF" },
          active: { scale: 1, backgroundColor: "#0057B7", color: "#0057B7" },
          complete: { scale: 1, backgroundColor: "#0057B7", color: "#60A5FA" },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#0057B7" },
  };

  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-gray-500">
      <motion.div
